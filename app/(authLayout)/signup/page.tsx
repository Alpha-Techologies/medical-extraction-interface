  ...
  return (
    <div className="h-screen w-full flex items-start justify-center font-inter py-8">
      ...
      <div className="w-2/3 gap-4">
        ...
        >
          <Form.Item name="first_name" className="w-full " rules={[yupSync]}>
            <Input className="h-9" placeholder="First Name" />
          </Form.Item>
          <Form.Item name="last_name" className="w-full " rules={[yupSync]}>
          ...
          <Form.Item name="organization" className="w-full " rules={[yupSync]}>
            <Input className="h-9" placeholder="Organization" />
          </Form.Item>
